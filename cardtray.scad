...
wall = 2.4;		    // Width of wall, see `internal_wall` below for alternate inner wall size.
internal_wall=0.8;
...
comp_size_x = 92 - (2 * 1.2); // external size add 2*wall to this
comp_size_y = 2 * ( 64 + 1.2 );   // external width add 2*wall to this
comp_size_deep = 13; // external height add 2*wall to thist
